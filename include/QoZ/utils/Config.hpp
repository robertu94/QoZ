...
namespace QoZ {
    ...
    constexpr const EB EB_OPTIONS[] = {EB_ABS, EB_REL, EB_PSNR, EB_L2NORM, EB_ABS_AND_REL, EB_ABS_OR_REL};

    enum ALGO {
        ALGO_LORENZO_REG, ALGO_INTERP_LORENZO, ALGO_INTERP,ALGO_INTERP_BLOCKED
    };
    constexpr const char *ALGO_STR[] = {"ALGO_LORENZO_REG", "ALGO_INTERP_LORENZO", "ALGO_INTERP","ALGO_INTERP_BLOCKED"};
    ...
    constexpr const INTERP_ALGO INTERP_ALGO_OPTIONS[] = {
        INTERP_ALGO_LINEAR, INTERP_ALGO_CUBIC
    };
